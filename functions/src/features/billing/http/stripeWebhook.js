    ...
    try {
      switch (event.type) {
        ...
        case "account.updated":
          // Note: Transfer of withdrawableEarnings is now handled in the updateStripeConnectId endpoint
          // when the account is connected. This webhook no longer handles transfers to avoid duplicates.
          // The account.updated event is still processed for other purposes if needed.
          break;
        default:
