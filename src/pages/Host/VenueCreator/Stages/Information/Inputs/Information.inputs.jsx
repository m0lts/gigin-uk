...
export const HostParkingInput = ({ hostExtraInfo, setParkingInfo }) => {
...
export const HostStageCapacityInput = ({ setMaxStageCapacity, hostExtraInfo }) => {
...
export const HostVenueCapacityInput = ({ setMaxVenueCapacity, hostExtraInfo }) => {
...
export const HostDescriptionInput = ({ setVenueDescription, hostExtraInfo }) => {
