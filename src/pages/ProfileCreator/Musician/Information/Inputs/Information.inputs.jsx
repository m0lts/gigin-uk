...
export const MusicianTypeInput = ({ setMusicType, musicianExtraInfo }) => {
...
export const MusicianGenresInput = ({ setGenres, musicianExtraInfo }) => {
...
export const MusicianBioInput = ({ setBio, musicianExtraInfo }) => {
