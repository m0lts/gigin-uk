...
import { EmptySubmitButton } from "../Buttons/Buttons"
import './addresses.styles.css'
...
export const AddressInputAutofill = ({ expandForm, setExpandForm, feature, setFeature, locationCoordinates, setLocationCoordinates, locationAddress, setLocationAddress }) => {
    ...
    const handleRetrieve = useCallback(
        (res) => {
            ...
            const address = feature.properties.place_name; // Change this according to the structure of your retrieved data
            const coordinates = feature.geometry.coordinates; // Assuming the coordinates are in [longitude, latitude] format

            // // Set the address and coordinates to the state variables
