        ...
        <div className="preview-gig-container">
          <ul className="preview-gig-list">
            ...
            {clickedVenues.map((venue, i) => (
              <li key={i} className="preview-gig-item" onClick={(e) => user?.musicianProfile?.id ? openInNewTab(`/venues/${venue.venueId}?musicianId=${user.musicianProfile.id}`, e) : openInNewTab(`/venues/${venue.venueId}`, e)}>
