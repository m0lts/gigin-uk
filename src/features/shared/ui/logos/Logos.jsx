...
export const TextLogoXL = () => {
    return (
        <h1 className='logo' style={{ fontFamily: 'Visby CF, sans-serif', fontWeight: 600, fontSize: '5rem' }}>gigin<span className='orange-txt' style={{ fontSize: '3rem' }}>.<span style={{ color: 'var(--gn-grey-600)', textTransform: 'uppercase', marginLeft: 5 }}>(beta)</span></span></h1>
    )
}
